...
Squib::Deck.new(width: 100, height: 150) do
  ...
  # Shadows off by default, i.e. shadow_offset, shadow_radius are nil
  ...
  # Also, you can expand the margin around the right and bottom with a negative shadow_trim
  save_png prefix: 'no_blur_', trim: 15, trim_radius: 15,
           shadow_radius: 0, shadow_trim: -5
